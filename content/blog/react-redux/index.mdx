...
id: react-redux
title: 'React Redux'
date: '2020-09-22T02:18:19.900Z'
description: 'Part 2 of the Redux series: Explores how React Redux helps to integrate Redux with React apps'
previous: 'redux'
---
...
<Figure>
  ...
  >
    <CappedWidthBox maxWidth={250} style={{ flexBasis: '40%' }}>
      <FixedAspectRatioBox aspectRatio={438 / 491}>
        <img
    ...
    <span role="img" aria-label="heart emoji" style={{ fontSize: '3em', flexBasix: '20%' }}>
      💖
    </span>
    <CappedWidthBox maxWidth={250} style={{ flexBasis: '40%' }}>
