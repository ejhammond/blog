...
import { FixedAspectRatioBox, CappedWidthBox } from '../../../src/components/FixedAspectRatioBox';
...
Now that we're using proper Redux-approved actions, our code looks somethingl ike this:
...
This reducer is much simpler, but it's actually quite broken for 2 reasons actually.
