...
- We defined 2 _actions_, `ADD_ACTION` and `SUBTRACT_ACTION`, which are just simple objects
- We defined the shape of the _state_ of our app: it looked like this `{ counter: number }`
