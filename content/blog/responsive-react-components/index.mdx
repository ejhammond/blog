...
<Figure>
  <CappedWidthBox maxWidth={300}>
    <FixedAspectRatioBox aspectRatio={111 / 301}>
      <img
        alt="Carousel on differently-sized screens"
        src="https://res.cloudinary.com/tripphamm/image/upload/v1577726270/tripps-tips/responsive-react-components/carousel-sizes_pihgd3.png"
      />
    </FixedAspectRatioBox>
  </CappedWidthBox>
</Figure>
