...
A while back, I joined a new team at Vistaprint where we were responsible for prototyping new features for Vistaprint's online editor, "Studio." The problem was that none of us had a significant amount of experience with these newer frameworks and we were about to start creating a pretty complex application.
